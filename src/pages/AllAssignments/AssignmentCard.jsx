...
const AssignmentCard = ({ assignment, handleDelete, handleUpdate }) => {
  ...
  return (
    <div className="shadow-lg relative bg-gray-100">
      ...
      <div className="">
        <h2 className="text-2xl font-extrabold mx-6 pt-4">
          {title}
        ...
        <div className="flex  gap-10 mx-6 uppercase">
          <p className="flex flex-col justify-center text-center bg-[#e8ede6] w-4/12 py-2 text-lg font-bold gap-1">
          ...
          <div className="flex flex-col gap-4 mt-4  ">
            ...
            <Link to={`/update/${_id}`} className="flex text-4xl">
              <GrDocumentUpdate />
